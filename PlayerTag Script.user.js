...
(function () {
    ...
    function PlayerTag_Main() {
        ...
        function CityPlayerTagInclude() {
            ...
            worldSectorObjectsMemberName = ClientLib.Data.WorldSector.prototype.SetDetails.toString().match(/case \$I\.[A-Z]{6}\.City:.*this\.([A-Z]{6})\.[A-Z]{6}\(r<<(?:16|0x10).*NewPlayerSlot/)[1];
            ...
            var matchList = webfrontend.gui.region.RegionCityMenu.prototype.onTick.toString()
						.match(/this\.([A-Za-z0-9_]+)!==null&&this\.[A-Za-z0-9_]+\(\)/);
            ...
            var updateColorParts = g(regionCityPrototype.UpdateColor, /this\.([A-Z]{6})\(/, "ClientLib.Vis.Region.RegionCity UpdateColor", 1);
            ...
            var setCanvasValueFunctionBodyFixed = setCanvasValueFunctionBody.replace(
                /\(this\.([A-Z]{6})\.Text\!=o\|\|this\.([A-Z]{6})\.Color\!=i\)&&\(r=!0,this\.([A-Z]{6})\.Text=o,this\.([A-Z]{6})\.Color=i\);/im,
                "(this.$1.Text!=this.BaseNameTag(o)||this.$1.Color!=i)&&(r=!0,this.$1.Text=this.BaseNameTag(o),this.$1.Color=i);");
            regionCityPrototype[setCanvasValue_Name] = new Function("n", "t", setCanvasValueFunctionBodyFixed);
            regionCityPrototype.SetCanvasValueTag_FIXED = new Function("n", "t", setCanvasValueFunctionBodyFixed);
                            ...
                            if (r == ClientLib.Vis.Region.RegionNPCBase) {
                                ...
                                var initBaseFunctionFixed = initBaseFunction.replace(
                                 ...
                                 initBaseFunctionFixed = initBaseFunctionFixed.replace(
                                    /e=([^;]*NPCBase\))/im,
                                    "e=this.BaseColor($1)");
                                regionObject[key] = new Function("n", "t", "i", "r", "u", initBaseFunctionFixed);
